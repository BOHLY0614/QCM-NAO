...
# Partie pour radio
questions = read_questions_and_answers("alessia/data_raw/droit_c4.txt", "alessia/data_raw/REP_dc4.txt")

input_file = "alessia/data_raw/REP_dc4.txt"
...
for chapitre, groupe in groupes.items():
    nom_fichier = f"Droit constitutionnel 4.json"
